class DetailsModal extends HTMLElement{constructor(){super();
...
}open(event){this.onBodyClickEvent=this.onBodyClickEvent||this.onBodyClick.bind(this);
...
}close(focusToggle=true){removeTrapFocus(focusToggle ? this.summaryToggle : null);
